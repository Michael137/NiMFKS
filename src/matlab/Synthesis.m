classdef Synthesis < handle
    ...
    methods
        ...
        function obj = synthesize(obj, synthMethod, costMetric, iterations, repititionRestricted, continuityEnhanced)
            if(strcmp(synthMethod, 'NNMF'))
                ...
                if(strcmp(costMetric, 'Euclidean'))
                    [H, cost]=nnmfFn(target, source, iterations, repititionRestricted, continuityEnhanced);
